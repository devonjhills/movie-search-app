...
import { cn, formatYear, formatVoteAverage, getRatingColor, truncateText } from '@/lib/utils';
        ...
        <CardContent className="p-0 space-y-3">
          ...
          <div className={cn('relative overflow-hidden rounded-lg', aspectRatio)}>
            ...
            {showRating && tvShow.vote_average > 0 && (
              <div className="absolute top-2 right-2 flex items-center space-x-1 rounded-full bg-black/70 px-2 py-1 text-xs font-medium text-white backdrop-blur-sm">
