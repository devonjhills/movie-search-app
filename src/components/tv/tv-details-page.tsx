          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-end">
              ...
              <div className="md:col-span-9 space-y-4 text-white">
                ...
                {tvShow.tagline && (
                  <p className="text-lg italic text-white/80">{tvShow.tagline}</p>
                )}
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {tvShow.overview && (
              <Card>
                ...
                <CardContent>
                  <p className="text-foreground/90 leading-relaxed">{tvShow.overview}</p>
                </CardContent>
              </Card>
            )}
                ...
                <CardContent>
                  <div className="space-y-4">
                    {tvShow.seasons.map(season => (
                      <div key={season.id} className="flex space-x-4 p-4 rounded-lg bg-muted/50">
