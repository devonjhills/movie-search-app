...
export function ShareButton({ 
  ...
  const baseClasses = "relative inline-flex items-center rounded-lg transition-colors focus:outline-none focus:ring-2";
  
  const variantClasses = {
    default: "bg-secondary text-secondary-foreground hover:bg-secondary/80 focus:ring-secondary/50",
    hero: "border border-white/30 text-white bg-white/10 backdrop-blur-sm hover:bg-white/20 focus:ring-white/50"
  };
